...
private:
    ...
    static void threadInsert(DoublyLinkedList<int>* list) {
    ...
    // used for testThreadSafe()
    static void threadRemove(DoublyLinkedList<int>* list) {
        list->remove(REMOVAL_VALUE);
    }

    // verifies thread safe property of DoublyLinkedList
...
public:
    void executeTests() {
        std::cout << "=== Testing doubly_linked_list.h ===" << std::endl;
        ...
        std::thread t5(testInsertAtIndex);
